  ...
  <div class="inline" v-if="user">
    <a href="#" class="user-pop" v-on:mouseover="hover" v-on:mouseout="hoverOut">{{ main }}</a>
    <div
      class="user-popover"
      v-if="showPopup"
      transition="fade"
    ...
    >
      <div
        class="user-popover--img"
        v-bind:style="{ backgroundImage: 'url('+user.profile.profile_image+')' }"
      >
