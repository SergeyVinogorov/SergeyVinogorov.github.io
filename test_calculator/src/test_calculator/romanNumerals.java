...
public class romanNumerals {
	       ...
	       int num;   // The number represented by this Roman numeral.
	       ...
	       */
	       ...
	       public romanNumerals(int arabic) {
	             ...
	             // not in the range 1 to 100 inclusive.
	          if (arabic < 1)
	             throw new NumberFormatException("Value of RomanNumeral must be positive.");
	          if (arabic > 10)
	             throw new NumberFormatException("Value of RomanNumeral must be 10 or less.");
	          num = arabic;
	       }
	       ...
	       public romanNumerals(String roman) {
	          ...
	          if (arabic > 10)
	             throw new NumberFormatException("Roman numeral must have value less 10 or equals 10.");
